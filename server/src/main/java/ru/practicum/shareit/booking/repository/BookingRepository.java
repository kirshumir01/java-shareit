...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    @EntityGraph(value = "booking-entity-graph")
    List<Booking> findAllByBookerIdAndStatusOrderByStartDesc(long bookerId, BookingStatus state);
    ...
    @EntityGraph(value = "booking-entity-graph")
    List<Booking> findAllByItemOwnerIdAndStatusOrderByStartDesc(long ownerId, BookingStatus state);
    ...
    Optional<Booking> findFirstByItemIdAndStartLessThanEqualAndStatus(
            long itemId, LocalDateTime now, BookingStatus status, Sort end);
    ...
    List<Booking> findByItemInAndStartLessThanEqualAndStatus(
            List<Item> items, LocalDateTime now, BookingStatus approved, Sort end);
